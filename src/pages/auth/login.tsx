      ...
      <div className="flex flex-col items-center justify-center w-full gap-7">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="flex flex-col items-center justify-center w-[250px] gap-3">
            <LoadingButton loading={isLoading} loadingText="logging in..." variant="outline" className={`text-black w-full !border !border-[#786BAA] rounded-[3px] !h-10`}
              disabled={!isLoginFormValid || isLoading} type="submit">
              Login
            </LoadingButton>
            <span className="text-white">or</span>
            {/* Custom Google Login Button */}
            <LoadingButton loading={isLoading} loadingText="logging with google..." className={`text-white w-full !border !border-white rounded-[3px] !h-10`}
              disabled={isLoading} type="button" onClick={() => googleLogin()}>
              Login with Google
            </LoadingButton>
          </div>
        </form>
