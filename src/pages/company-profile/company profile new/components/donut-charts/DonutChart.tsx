...
import { calculateLabelPosition } from '../../utils/chartUtils';
            ...
            <div className="p-6">
                <div className="flex justify-center">
                    <svg width="300" height="300" viewBox="-80 0 500 500">
                        {/* Draw Empty Donut */}
                        <path d={emptyDonutPath} fill={emptyColor} strokeWidth={2} className="transition-colors duration-300" />
                        {/* Center Content */}
            ...
            <div className="flex justify-center">
                <svg width="300" height="300" viewBox="-80 0 500 500">
                    ...
                    {segments.map((segment, index) => (
                        <path key={index} d={segment.path} fill={segment.color} strokeWidth={2} className="transition-colors duration-300" />
                    ))}
                        ...
                        return (
                            <g key={index}>
                                ...
                                <text
                                    ...
                                    fontSize={16}
                                    fontWeight="bold"
                                    className="font-bold text-[12px] fill-[#323232]"
                                >
                                    {segment.percentage}%
                                </text>
                                <text
                                    ...
                                    fill="#323232"
                                    fontSize={12}
                                    className="text-[12px] fill-[#323232]"
                                >
                                    {segment.label}
                                </text>
                            </g>
